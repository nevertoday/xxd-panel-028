...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 028 样张 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 028 样张 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 028 样张 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 028 样张 8"></td>
  </tr>
</table>

## 新增 3:4 上下双联样张

以下四张复用上方 16:9 样张对应的四张独立素材，重新生成完整 3:4 上下双联画布；上部保留现实摄影，下部遵循 028 原始提示词重构。英文配字只从当前照片的内容、情绪或隐喻中生成，并已逐张复核。

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 028 新增上下样张 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 028 新增上下样张 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 028 新增上下样张 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 028 新增上下样张 4"></td>
  </tr>
</table>
...
**Panel 028** 适合这类任务：需要保留原图核心内容，同时希望最终视觉达到以下方向：**把照片安放成一件源图配色的等距纸上微缩景观**。它先从用途与期望结果出发，再决定构图、尺寸、文字和具体输出形式。
...
> 用 XXD Panel 028 帮我处理这张图，先推荐最合适的构图和尺寸。
...
- [Skill 工作流](SKILL.md)
- [中文运行适配器](references/xxd-panel-028-prompt.zh-CN.md)
- [英文运行适配器](references/xxd-panel-028-prompt.en.md)
