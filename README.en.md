...
That frustration is why I made **Panel 028**. It does not press a template onto your image. It first works out what must not be lost, then translates it into **Place the photograph into a source-colour isometric miniature on paper**.
...
> Use XXD Panel 028 on this image and recommend the best layout and size first.
...
<table>
  ...
  <tr>
    <td colspan="2"><img src="./assets/examples/sample-05.png" alt="XXD Panel 028 Sample 5"></td>
  </tr>
  <tr>
    <td width="33%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 028 Sample 6"></td>
    <td width="33%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 028 Sample 7"></td>
    <td width="33%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 028 Sample 8"></td>
  </tr>
</table>
...
/xxd-panel-028 photo.jpg --mode top-bottom --size auto --text prompt --locale en-GB
...
/xxd-panel-028 photo.jpg --mode design-only --size 3:4 --copy "Let the light stay" --locale en-GB

# Two modes × three sizes produce six independently composed assets
/xxd-panel-028 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale en-GB

# Apply Panel 028 to a whole directory; shared settings resolve once
/xxd-panel-028 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale en-GB
...
- [Chinese runtime adapter](references/xxd-panel-028-prompt.zh-CN.md)
- [English runtime adapter](references/xxd-panel-028-prompt.en.md)
